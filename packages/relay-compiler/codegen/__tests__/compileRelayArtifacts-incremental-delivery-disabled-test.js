...
describe('compileRelayArtifacts (incremental delivery disabled)', () => {
  ...
  generateTestsFromFixtures(
    `${__dirname}/fixtures/compileRelayArtifacts-incremental-delivery-disabled`,
    text => {
